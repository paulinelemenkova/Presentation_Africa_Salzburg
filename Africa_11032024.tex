...
\begin{figure}[H]
	...
	\caption{General geologic map of the seafloor of the Pacific Ocean. Source: \cite{Lemenkova202106}}\label{fig:POg.jpg}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{ETOPO1 grid for topographic mapping: example of Aleutian Trench. Source: author.}\label{fig:AT1}
\end{figure}
Solutions of GMT: 
...
\begin{figure}[H]
	...
	\caption{Map showing geological settings in the Middle America Trench. Source: \cite{Lemenkova2019108}}\label{fig:MAT5}
\end{figure}
\end{frame}
...
\begin{figure}[H]
	...
	\caption{Cross-section profiles of the Peru-Chile Trench. Source: \cite{Lemenkova2019107}}\label{fig:PCT6}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Modeled cross-section profiles of the Hikurangi Trench. Source: \cite{Lemenkova202031}}\label{fig:H2}
\end{figure}
...
\begin{figure}[H]
	\centering
		...
		\caption{Modeled cross-section profiles of the Puysegur and Hjort trenches. Source: \cite{Lemenkova202031}}\label{fig:P2}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Geologic map and tectonic setting of the Vanuatu (New Hebrides) and Vityaz trenches. Source: \cite{Lemenkova202003}}\label{fig:VV2}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
\vspace{3em}
...
\begin{dinglist}{123}\footnotesize
     \item The application of geological big data enables to utilise both \textcolor{red}{structured} and \textcolor{red}{unstructured} datasets
     \item These include data from \textcolor{red}{a variety of disciplines}, such as geology \cite{Huangetal2017}, geophysics \cite{Lietal2019}, geochemistry \cite{Jiaoetal2018}, geoinformatics and remote sensing \cite{Lemenkova202019}, submarine geomorphology \cite{Lemenkova202018}, hydrology and risk disasters (tsunamis, submarine landslides, submarine volcanoes, earthquakes) \cite{Chenetal2015}.
     \item Digital geological Big data present an \textcolor{red}{integration} of geospatial data, collection of resources, data transmission, information extraction and knowledge mining \cite{Zhuetal2018}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=6cm]{Fig-NBT1.jpg}
	\caption{Topographic map of the New Britain and San Cristobal trenches, east Papua New Guinea. Source: \cite{Lemenkova202025}}\label{fig:NBT1}
\end{figure}
\end{column}
\begin{column}{0.4\textwidth}	
...
\begin{figure}[H]
	...
	\caption{Example of the cross-section profiles of the New Britain and San Cristobal trenches. Source: \cite{Lemenkova202025}}\label{fig:NBT6}
\end{figure}
\end{column}
\begin{column}{0.4\textwidth}	
...
\begin{figure}[H]
	...
	\caption{Plotting by Python (Matplotlib library): distribution of the bathymetric samples of the cross-section profiles. Source: \cite{Lemenkova202010}}\label{fig:Ph08}
\end{figure}
%\vspace{1em}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=5.0cm]{Fig-Ph09.jpg}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=5.0cm]{Fig-Ph10.jpg}
...
\begin{dinglist}{112}\footnotesize
     ...
     \item It is important to \textcolor{red}{model correlations} among these factors (geophysics, seismicity, tectonics, geology, physical geography, currents, sediment thickness \cite{Lemenkova202008}) in a way that effectively handles uncertainties of formations of the trenches
     \item Effective Earth data modelling highlights the impact on geomorphology of the trenches \cite{Lemenkova202015} as a result of \textcolor{red}{variations} in tectonic setting (speed of slab subduction, density and age of the lithosphere plate) and regional oceanological parameters
      \item Benefits of automatisation for big Earth data processing:
		...
		\end{dinglist}
     \item So it is necessary to apply automatisation in cartographic processing through scripting cartographic methods and machine learning models using Python and R statistical libraries in order to visualise and analyse the seafloor structure    
\end{dinglist}
\end{column}
\end{columns}
\end{minipage}
...
\begin{column}{0.5\textwidth}
\vspace{2em}
\begin{dinglist}{233}\scriptsize
     \item Geological research of the Ryukyu trench area is concerned with problems of \textcolor{red}{Philippine Sea Plate subduction}, \textcolor{red}{seismic activity} and associated formation of the trench-arc system 
     \item Geology is special discipline compared to other natural and technical science in that it is an observational science branch
     \item Geologic observations received from geological fieldwork, investigations and \emph{in-situ} data collection can be stored in large amount of the multi-format data
     \item Geologic case data include rock genesis, mineral deposit genesis, metamorphic rock genesis, sedimentary rock genesis, etc \cite{ZhangLiu2019}: e.g. basalt magma undergoes separation and crystallisation.
     \item Explosive growth in the overwhelming amount of geological data is now processed by the high-performance computers and machine learning methods of statistical analysis for effective data processing
     \item Advanced methods of data analysis and scripting mapping technologies applied for big geologic datasets made possible to move geology into the \textcolor{red}{quantitative research}
     \item Marine geological big datasets are taken from cruise observations and regular survey on R/V, drilling and engineering exploration, remote seising and analytical testing, statistical analysis and modelling
     \item Big Earth datasets designed for visualising deep-sea trenches in the zones of subduction 
     \item \textcolor{red}{Smart geologic intelligent systems} will be developing in the future using Artificial Intelligence (AI) for predictive mineral prospecting, seismic prognosis and hazard risk mitigation \cite{Zhouetal2018}
 \end{dinglist}
\end{column}
\end{columns}
\end{minipage}
...
\begin{figure}[H]
	...
	\caption{Topographic location of the Yap and Palau Trenches. Source: \cite{Lemenkova2019106}}\label{fig:H1}
\end{figure}
\end{column}
\begin{column}{0.5\textwidth}
\vspace{2em}
...
\begin{dinglist}{217}\footnotesize
     \item Mapping and modelling \textcolor{red}{interactions} of marine geologic and tectonic processes is important to understanding the geomorphology of the deep-sea trenches
     \item To this end, \textcolor{red}{scripting technical advancement} in cartography (GMT, GRASS GIS \cite{Lemenkova202022}, \cite{Lemenkova202016}, \cite{Lemenkova202011}, \cite{Lemenkova202032}) has enabled the generation of large volumes of Earth data through rapid and accurate mapping 
     \item Besides, \textcolor{red}{statistical and machine learning techniques} (Python, R) can help visualise bathymetric patterns in trenches
     ...
     \item This insight is difficult to develop without machine learning techniques and advanced cartography because it requires rapid and accurate processing of \textcolor{red}{large volumes of spatial data}
\end{dinglist}
\end{column}
\end{columns}
\end{minipage}
...
\begin{columns}[T]
\begin{column}{0.4\textwidth}
Challenges of big Earth data manipulation 
\begin{dinglist}{84}\footnotesize
   	 \item Big Earth data capture is a technical challenge: data are gathered from the diverse sources and quantities of pixels (e.g. GEBCO2019.nc 11.72 Gb of data). This provides a problem of storing data \cite{Merrittetal2018}
	 ...
	 \item Effects of visualisation by GMT enable to plot pseudo-3D maps
...
\begin{figure}[H]
	...
	\caption{Cross-section profiles of the IBT. Source: \cite{Lemenkova202005}}\label{fig:IBT7}
\end{figure}	
...
\begin{dinglist}{105}\footnotesize
     \item GMT module 'grdview' turns Earth data (e.g. GEBCO, ETOPO1, ETOPO5) into visual 3D representations of the trenches
\end{dinglist} 
\end{column}
\begin{column}{0.5\textwidth}
\vspace{2em}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=5.5cm]{S05.jpg}
	\caption{Snippet of the GMT script for mapping Japan Trench}\label{fig:S05}
\end{figure}
\end{column}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=4.5cm]{Fig-JT6.jpg}
	\caption{GMT-based 3D modelling of the Japan Trench. Source: \cite{Lemenkova202012}}\label{fig:JT6}
\end{figure}
\end{column}
\end{columns}
\end{minipage}
