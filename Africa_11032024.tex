...
\begin{figure}[H]
	...
	\caption{General bathymetric map of the seafloor of the Pacific Ocean, ETOPO1. Source:}\label{fig:PO.jpg}
\end{figure}\small
...
\begin{figure}[H]
	...
	\caption{General geologic map of the seafloor of the Pacific Ocean. Source:}\label{fig:02.jpg}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Information extraction from RS data: classification the Landsat images of Lorian swamp, Kenya. Source: }\label{fig:NBT6}
\end{figure}
\vspace{-35pt}
\begin{figure}[H]
	\centering
		\includegraphics[width=6cm]{Fig_30.jpg}
	\caption{False color composites of the Landsat 8-9 OLI/TIRS images: wetlands around Lorian swamp, Kenya. Source: }\label{fig:NBT6}
\end{figure}
\end{column}
