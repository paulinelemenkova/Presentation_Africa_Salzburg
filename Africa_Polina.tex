\documentclass[pdflatex,compress,8pt,
	...
	hyperref={colorlinks = true, breaklinks = true, urlcolor = NavyBlue, linkcolor=blue, breaklinks = true}]{beamer}
\usetheme{AnnArbor}
