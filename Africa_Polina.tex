...
\subtitle{\emph{Research Proposal for a PhD Thesis}\\
Supervisors: Prof. Dr. Stefan Lang and Prof. Dr. Dirk Tiede}
...
\begin{itemize}\footnotesize
     ...
     \item Mapping using diverse data (geologic, topographic, land cover types) helps get better insights into the underlying processes of landscape formation which affect the distribution of vegetation types across various ecoregions of Ghana.      
\end{itemize}
\end{alertblock}
\end{column}
\end{columns}
...
\begin{figure}[H]
	\centering
		\includegraphics[width=4.5cm]{Fig_49.jpg}
