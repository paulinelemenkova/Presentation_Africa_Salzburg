...
\begin{figure}[H]
	...
	\caption{Example of the GEBCO grid used for mapping trench}
\end{figure}
\end{column}
\end{columns}
\end{minipage}
...
\begin{figure}[H]
	...
	\caption{Snippet of the Octave/MATLAB script used for modeling the Kuril-Kamchatka Trench}
\end{figure}	
\end{column}
...
\begin{figure}[H]
	...
	\caption{Cross-section profiles of the Kuril-Kamchatka Trench. Plotting: Octave. Source:}
\end{figure}
\begin{itemize}
